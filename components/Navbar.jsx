  ...
  >
    ...
    <div className={`${styles.innerWidth} mx-auto flex justify-between gap-8`}>
      ...
      <button type="button" className="flex items-center h-fit py-4 px-6 bg-[#25618b] rounded-[32px] gap-[12px]">
        ...
        <Link href="https://drive.google.com/file/d/1gR_RTIUp0HK6BMjJvmH3pK_o-sRCaeqo/view?usp=sharing"><span className="font-normal text-[16px] text-white">Resume</span></Link>
      </button>
