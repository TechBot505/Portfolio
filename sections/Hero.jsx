    ...
    <section className={`${styles.yPaddings} sm:pl-16 pl-16`}>
      ...
      >
        ...
        >
          ...
          <img src="/cover-2.png" alt="cover" className="w-full object-cover sm:h-[500px] h-[350px] rounded-tl-[140px] z-[10] relative" />
          <a href="#projects">
            <div className="w-full flex justify-end sm:-mt-[70px] -mt-[50px] pr-[40px] relative z-10">
              <img src="/stamp-1.png" alt="stamp" className="sm:w-[155px] w-[100px] sm:h-[155px] h-[100px] object-contain hover:opacity-90" />
            </div>
          </a>
        </motion.div>
      </motion.div>
